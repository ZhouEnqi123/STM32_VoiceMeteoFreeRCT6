...
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xfc, 0x84, 0xfc, 0xfc, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x3e, 0x3f, 0x7f, 
0x3f, 0x3f, 0x1c, 0x00, 0x00, 0x00, 0x00, 0x00, 
};
const Image tempImg = {16, 16, tempData};

const uint8_t humiData[] = {
...
const Image humiImg = {16, 16, humiData};

const uint8_t ％Data[] = {
0x00, 0x00, 0x00, 0xf8, 0x88, 0xf8, 0xf8, 0x80, 0xe0, 0xf0, 0x38, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x10, 0x1c, 0x0f, 0x07, 
0x01, 0x1f, 0x1f, 0x11, 0x1f, 0x00, 0x00, 0x00, 
};
const Image ％Img = {16, 16, ％Data};

const uint8_t WeatherSunnyData[] = {
0x00, 0x80, 0x80, 0x98, 0xd8, 0xe0, 0x30, 0x3e, 0x3e, 0x30, 0x60, 0xd8, 0x98, 0x80, 0x80, 0x00, 0x00, 0x01, 0x01, 0x19, 0x1b, 0x07, 0x0c, 0x7c, 
0x7c, 0x0c, 0x06, 0x1b, 0x19, 0x11, 0x01, 0x00, 
};
const Image WeatherSunnyImg = {16, 16, WeatherSunnyData};

const uint8_t WeatherPartlyCloudyData[] = {
0x00, 0x00, 0x80, 0xc0, 0xc0, 0xe0, 0x70, 0x38, 0x18, 0x18, 0x18, 0x18, 0x78, 0xf0, 0xe0, 0x00, 0x00, 0x0f, 0x1f, 0x1d, 0x18, 0x18, 0x18, 0x18, 
0x18, 0x18, 0x18, 0x18, 0x1e, 0x0f, 0x07, 0x00, 
};
const Image WeatherPartlyCloudyImg = {16, 16, WeatherPartlyCloudyData};

const uint8_t WeatherCloudyData[] = {
0x00, 0x00, 0x80, 0xc0, 0xc0, 0xe0, 0xb0, 0x30, 0x30, 0x38, 0xf0, 0xbc, 0xf0, 0xf8, 0xe0, 0x00, 0x00, 0x0f, 0x1f, 0x30, 0x30, 0x30, 0x31, 0x30, 
0x30, 0x30, 0x30, 0x31, 0x1f, 0x0f, 0x01, 0x00, 
};
const Image WeatherCloudyImg = {16, 16, WeatherCloudyData};

const uint8_t WeatherOvercastData[] = {
0x00, 0x00, 0xc0, 0xf0, 0xb8, 0x1c, 0x0c, 0x0c, 0x1c, 0xf8, 0xf0, 0x60, 0xe0, 0xc0, 0x80, 0x00, 0x00, 0x1f, 0x1f, 0x31, 0x30, 0x30, 0x30, 0x30, 
0x30, 0x30, 0x30, 0x30, 0x38, 0x1f, 0x0f, 0x00, 
};
const Image WeatherOvercastImg = {16, 16, WeatherOvercastData};

const uint8_t WeatherLightRainData[] = {
0x00, 0x00, 0xc0, 0xe0, 0x70, 0x38, 0x0c, 0x0c, 0x0c, 0x0c, 0x38, 0x70, 0xe0, 0xc0, 0x00, 0x00, 0x00, 0x00, 0x03, 0x07, 0x06, 0x06, 0x1e, 0x3e, 
0x7e, 0x3e, 0x06, 0x06, 0x07, 0x03, 0x00, 0x00, 
};
const Image WeatherLightRainImg = {16, 16, WeatherLightRainData};

const uint8_t WeatherModerateRainData[] = {
0x00, 0xc0, 0xc0, 0x70, 0x10, 0x30, 0x18, 0x0c, 0x04, 0x04, 0x0c, 0x38, 0x70, 0xc0, 0xc0, 0x00, 0x00, 0x03, 0x06, 0x06, 0x7c, 0x7c, 0x3c, 0x3c, 
0x04, 0x7c, 0x04, 0x3c, 0x06, 0x06, 0x03, 0x00, 
};
const Image WeatherModerateRainImg = {16, 16, WeatherModerateRainData};

const uint8_t WeatherHeavyRainData[] = {
0x00, 0x00, 0xc0, 0xe0, 0x70, 0x38, 0x0c, 0x0c, 0x0c, 0x0c, 0x38, 0x70, 0xe0, 0xc0, 0x00, 0x00, 0x00, 0x00, 0x03, 0x3f, 0x3e, 0x26, 0x3e, 0x0e, 
0x3e, 0x3e, 0x26, 0x3e, 0x0f, 0x03, 0x00, 0x00, 
};
const Image WeatherHeavyRainImg = {16, 16, WeatherHeavyRainData};

const uint8_t WeatherThunderstormData[] = {
0x00, 0x00, 0xf0, 0xf0, 0xf0, 0xfc, 0xfe, 0xfe, 0xfe, 0xfe, 0xfe, 0xf0, 0xf0, 0xf0, 0x00, 0x00, 0x00, 0x00, 0x03, 0x73, 0x7f, 0x73, 0x33, 0xfb, 
0x33, 0x13, 0x7b, 0x7b, 0x23, 0x01, 0x00, 0x00, 
};
const Image WeatherThunderstormImg = {16, 16, WeatherThunderstormData};

const uint8_t WeatherSleetData[] = {
0xc0, 0x60, 0x70, 0x38, 0x18, 0x18, 0x0c, 0x06, 0x06, 0x06, 0x06, 0x06, 0x3c, 0x70, 0x60, 0xc0, 0x07, 0x06, 0x7c, 0x7c, 0x04, 0x04, 0x34, 0x7c, 
0x7c, 0x34, 0x04, 0x04, 0x7c, 0x7c, 0x06, 0x07, 
};
const Image WeatherSleetImg = {16, 16, WeatherSleetData};

const uint8_t WeatherLightSnowData[] = {
0x00, 0xc0, 0xe0, 0x70, 0x30, 0x38, 0x6c, 0x4c, 0x0c, 0x0c, 0x0c, 0x38, 0x70, 0xc0, 0xc0, 0x00, 0x00, 0x07, 0x07, 0x0c, 0x08, 0x1e, 0x16, 0x3c, 
0x3c, 0x06, 0x1e, 0x0c, 0x0c, 0x0e, 0x07, 0x00, 
};
const Image WeatherLightSnowImg = {16, 16, WeatherLightSnowData};

const uint8_t WeatherModerateSnowData[] = {
0x00, 0xc0, 0xe0, 0x70, 0x30, 0x38, 0x6c, 0x4c, 0x0c, 0x0c, 0x0c, 0x38, 0x70, 0xc0, 0xc0, 0x00, 0x00, 0x07, 0x07, 0x0c, 0x08, 0x1e, 0x16, 0x3c, 
0x3c, 0x06, 0x1e, 0x0c, 0x0c, 0x0e, 0x07, 0x00, 
};
const Image WeatherModerateSnowImg = {16, 16, WeatherModerateSnowData};

const uint8_t WeatherHeavySnowData[] = {
0x00, 0xc0, 0xe0, 0x70, 0x30, 0x38, 0x6c, 0x4c, 0x0c, 0x0c, 0x0c, 0x38, 0x70, 0xc0, 0xc0, 0x00, 0x00, 0x07, 0x07, 0x0c, 0x08, 0x1e, 0x16, 0x3c, 
0x3c, 0x06, 0x1e, 0x0c, 0x0c, 0x0e, 0x07, 0x00, 
};
const Image WeatherHeavySnowImg = {16, 16, WeatherHeavySnowData};

const uint8_t WeatherFogData[] = {
0x00, 0xc0, 0x70, 0x38, 0x18, 0x18, 0x1c, 0x04, 0x06, 0x06, 0x06, 0x0c, 0x78, 0x60, 0xc0, 0x00, 0x00, 0x3f, 0x3f, 0x3f, 0x3f, 0x3f, 0x3f, 0x3f, 
0x0f, 0x0f, 0x0f, 0x0f, 0x03, 0x03, 0x03, 0x00, 
};
const Image WeatherFogImg = {16, 16, WeatherFogData};

const uint8_t WeatherHailData[] = {
0x00, 0xc0, 0xe0, 0x70, 0x30, 0x38, 0x6c, 0x4c, 0x0c, 0x0c, 0x0c, 0x38, 0x70, 0xc0, 0xc0, 0x00, 0x00, 0x07, 0x07, 0x0c, 0x08, 0x1e, 0x16, 0x3c, 
0x3c, 0x06, 0x1e, 0x0c, 0x0c, 0x0e, 0x07, 0x00, 
};
const Image WeatherHailImg = {16, 16, WeatherHailData};

const uint8_t WeatherDustData[] = {
0x00, 0xc0, 0x70, 0x38, 0x18, 0x18, 0x1c, 0x04, 0x06, 0x06, 0x06, 0x0c, 0x78, 0x60, 0xc0, 0x00, 0x00, 0x3f, 0x3f, 0x3f, 0x3f, 0x3f, 0x3f, 0x3f, 
0x0f, 0x0f, 0x0f, 0x0f, 0x03, 0x03, 0x03, 0x00, 
};
const Image WeatherDustImg = {16, 16, WeatherDustData};

const uint8_t WeatherUnknownData[] = {
0x00, 0xf0, 0xf8, 0x1c, 0x0e, 0x66, 0x76, 0x1e, 0x9e, 0xf6, 0xe6, 0x0e, 0x1c, 0xf8, 0xf0, 0x00, 0x00, 0x0f, 0x1f, 0x38, 0x70, 0x60, 0x60, 0x7f, 
0x7f, 0x61, 0x60, 0x70, 0x38, 0x1f, 0x0f, 0x00, 
};
const Image WeatherUnknownImg = {16, 16, WeatherUnknownData};

const uint8_t NoWIFIData[] = {
0x20, 0x70, 0x38, 0xdc, 0xec, 0x6c, 0xbe, 0xb6, 0xb6, 0xbe, 0x6c, 0xec, 0xdc, 0xb8, 0x70, 0x20, 0x00, 0x00, 0x00, 0x01, 0x00, 0x03, 0x4b, 0x31, 
0x31, 0x4b, 0x03, 0x00, 0x00, 0x00, 0x00, 0x00, 
};
const Image NoWIFIImg = {16, 16, NoWIFIData};

const uint8_t AlarmData[] = {
0x00, 0x8c, 0xfe, 0x3e, 0x0e, 0x0c, 0x04, 0xe6, 0xe6, 0x04, 0x0c, 0x0e, 0x3e, 0xfe, 0x8c, 0x00, 0x00, 0x01, 0x4f, 0x7c, 0x30, 0x30, 0x20, 0x61, 
0x63, 0x23, 0x32, 0x30, 0x7c, 0x0f, 0x01, 0x00, 
};
const Image AlarmImg = {16, 16, AlarmData};
